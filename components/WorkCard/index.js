...
const WorkCard = ({ data }) => {
    ...
    return (
        <div className="h-full flex flex-col rounded-lg bg-white/10 p-2 laptop:p-4 shadow-lg shadow-white/10 hover:shadow-lg hover:shadow-white/50 transition-all duration-300">
